...
def train():
    # Path to where MineRL dataset resides (should contain ":MineRLBasaltFindCave-v0" directory)
    ...
    th.save(network, "find_cave_bc_baselineV4.pth")
    del data


def enjoy():
    network = th.load("find_cave_bc_baselineV3.pth").cuda()
